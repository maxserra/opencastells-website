...
export const pinyaGeometries = {
  ...
  3: {
    ...
    pinya: [
      ...
      { id: 'agulla_b1',              x: 500,                                      y: 465,                                      r: 20,       label: 'agulla',     shape: 'rect', direction: 180 },
      ...
      { id: 'agulla_b2',              x: Math.round(420 + 60 * Math.sin(RAD_60)),  y: Math.round(547 - 60 * Math.cos(RAD_60)),  r: 20,       label: 'agulla',     shape: 'rect', direction: 240 },
      ...
      { id: 'agulla_b3',              x: Math.round(581 + 60 * Math.sin(RAD_300)), y: Math.round(547 - 60 * Math.cos(RAD_300)), r: 20,       label: 'agulla',     shape: 'rect', direction: 120 },
      ...
      { id: 'vent_1_1',               x: Math.round((500+420)/2 + 124 * Math.sin(RAD_300)), y: Math.round((405+547)/2 - 124 * Math.cos(RAD_300)), r: 35, label: '1 vent', shape: 'rect', direction: 120 },
      { id: 'vent_1_2',               x: Math.round((500+420)/2 + 184 * Math.sin(RAD_300)), y: Math.round((405+547)/2 - 184 * Math.cos(RAD_300)), r: 35, label: '2 vent', shape: 'rect', direction: 120 },
      { id: 'vent_1_3',               x: Math.round((500+420)/2 + 244 * Math.sin(RAD_300)), y: Math.round((405+547)/2 - 244 * Math.cos(RAD_300)), r: 35, label: '3 vent', shape: 'rect', direction: 120 },
      { id: 'vent_1_4',               x: Math.round((500+420)/2 + 304 * Math.sin(RAD_300)), y: Math.round((405+547)/2 - 304 * Math.cos(RAD_300)), r: 35, label: '4 vent', shape: 'rect', direction: 120 },
      // ── vent 2 (going straight down) ──────────────────────────────────
      { id: 'vent_2_1',               x: 500,                                               y: 675,                                               r: 35, label: '1 vent', shape: 'rect', direction: 0 },
      { id: 'vent_2_2',               x: 500,                                               y: 735,                                               r: 35, label: '2 vent', shape: 'rect', direction: 0 },
      { id: 'vent_2_3',               x: 500,                                               y: 795,                                               r: 35, label: '3 vent', shape: 'rect', direction: 0 },
      { id: 'vent_2_4',               x: 500,                                               y: 855,                                               r: 35, label: '4 vent', shape: 'rect', direction: 0 },
      // ── vent 3 (going upper-right) ────────────────────────────────────
      { id: 'vent_3_1',               x: Math.round((500+581)/2 + 124 * Math.sin(RAD_60)),  y: Math.round((405+547)/2 - 124 * Math.cos(RAD_60)),  r: 35, label: '1 vent', shape: 'rect', direction: 240 },
      { id: 'vent_3_2',               x: Math.round((500+581)/2 + 184 * Math.sin(RAD_60)),  y: Math.round((405+547)/2 - 184 * Math.cos(RAD_60)),  r: 35, label: '2 vent', shape: 'rect', direction: 240 },
      { id: 'vent_3_3',               x: Math.round((500+581)/2 + 244 * Math.sin(RAD_60)),  y: Math.round((405+547)/2 - 244 * Math.cos(RAD_60)),  r: 35, label: '3 vent', shape: 'rect', direction: 240 },
      { id: 'vent_3_4',               x: Math.round((500+581)/2 + 304 * Math.sin(RAD_60)),  y: Math.round((405+547)/2 - 304 * Math.cos(RAD_60)),  r: 35, label: '4 vent', shape: 'rect', direction: 240 },
      // ── lateral right b1 (upper-left, extending @ 300°) ───────────────────
      { id: 'lateral_right_b1_1',     x: Math.round(530 + 124 * Math.sin(RAD_300)), y: Math.round(385 - 124 * Math.cos(RAD_300)), r: 30, label: '1 lateral', shape: 'rect', direction: 90 },
      { id: 'lateral_right_b1_2',     x: Math.round(530 + 184 * Math.sin(RAD_300)), y: Math.round(385 - 184 * Math.cos(RAD_300)), r: 30, label: '2 lateral', shape: 'rect', direction: 90 },
      { id: 'lateral_right_b1_3',     x: Math.round(530 + 244 * Math.sin(RAD_300)), y: Math.round(385 - 244 * Math.cos(RAD_300)), r: 30, label: '3 lateral', shape: 'rect', direction: 90 },
      { id: 'lateral_right_b1_4',     x: Math.round(530 + 304 * Math.sin(RAD_300)), y: Math.round(385 - 304 * Math.cos(RAD_300)), r: 30, label: '4 lateral', shape: 'rect', direction: 90 },
      // ── lateral left b1 (upper-right) ────────────────────────────────
      { id: 'lateral_left_b1_1',      x: Math.round(470 + 124 * Math.sin(RAD_60)),  y: Math.round(385 - 124 * Math.cos(RAD_60)),  r: 30, label: '1 lateral', shape: 'rect', direction: 270 },
      { id: 'lateral_left_b1_2',      x: Math.round(470 + 184 * Math.sin(RAD_60)),  y: Math.round(385 - 184 * Math.cos(RAD_60)),  r: 30, label: '2 lateral', shape: 'rect', direction: 270 },
      { id: 'lateral_left_b1_3',      x: Math.round(470 + 244 * Math.sin(RAD_60)),  y: Math.round(385 - 244 * Math.cos(RAD_60)),  r: 30, label: '3 lateral', shape: 'rect', direction: 270 },
      { id: 'lateral_left_b1_4',      x: Math.round(470 + 304 * Math.sin(RAD_60)),  y: Math.round(385 - 304 * Math.cos(RAD_60)),  r: 30, label: '4 lateral', shape: 'rect', direction: 270 },
      // ── lateral right b2 (lower, toward b3 side) ─────────────────────
      { id: 'lateral_right_b2_1',     x: 390,                                       y: 656,                                       r: 30, label: '1 lateral', shape: 'rect', direction: 330 },
      { id: 'lateral_right_b2_2',     x: 390,                                       y: 719,                                       r: 30, label: '2 lateral', shape: 'rect', direction: 330 },
      { id: 'lateral_right_b2_3',     x: 390,                                       y: 782,                                       r: 30, label: '3 lateral', shape: 'rect', direction: 330 },
      { id: 'lateral_right_b2_4',     x: 390,                                       y: 846,                                       r: 30, label: '4 lateral', shape: 'rect', direction: 330 },
      // ── lateral left b2 (upper-left, extending @ 300°) ─────────────────────
      { id: 'lateral_left_b2_1',      x: Math.round(420 + 124 * Math.sin(RAD_300)), y: Math.round(580 - 124 * Math.cos(RAD_300)), r: 30, label: '1 lateral', shape: 'rect', direction: 150 },
      { id: 'lateral_left_b2_2',      x: Math.round(420 + 184 * Math.sin(RAD_300)), y: Math.round(580 - 184 * Math.cos(RAD_300)), r: 30, label: '2 lateral', shape: 'rect', direction: 150 },
      { id: 'lateral_left_b2_3',      x: Math.round(420 + 244 * Math.sin(RAD_300)), y: Math.round(580 - 244 * Math.cos(RAD_300)), r: 30, label: '3 lateral', shape: 'rect', direction: 150 },
      { id: 'lateral_left_b2_4',      x: Math.round(420 + 304 * Math.sin(RAD_300)), y: Math.round(580 - 304 * Math.cos(RAD_300)), r: 30, label: '4 lateral', shape: 'rect', direction: 150 },
      // ── lateral left b3 (lower, toward b2 side) ──────────────────────
      { id: 'lateral_left_b3_1',      x: 610,                                       y: 656,                                       r: 30, label: '1 lateral', shape: 'rect', direction: 30 },
      { id: 'lateral_left_b3_2',      x: 610,                                       y: 719,                                       r: 30, label: '2 lateral', shape: 'rect', direction: 30 },
      { id: 'lateral_left_b3_3',      x: 610,                                       y: 782,                                       r: 30, label: '3 lateral', shape: 'rect', direction: 30 },
      { id: 'lateral_left_b3_4',      x: 610,                                       y: 846,                                       r: 30, label: '4 lateral', shape: 'rect', direction: 30 },
      // ── lateral right b3 (upper-right, extending @ 60°) ──────────────────────
      { id: 'lateral_right_b3_1',     x: Math.round(580 + 124 * Math.sin(RAD_60)),  y: Math.round(580 - 124 * Math.cos(RAD_60)),  r: 30, label: '1 lateral', shape: 'rect', direction: 210 },
      { id: 'lateral_right_b3_2',     x: Math.round(580 + 184 * Math.sin(RAD_60)),  y: Math.round(580 - 184 * Math.cos(RAD_60)),  r: 30, label: '2 lateral', shape: 'rect', direction: 210 },
      { id: 'lateral_right_b3_3',     x: Math.round(580 + 244 * Math.sin(RAD_60)),  y: Math.round(580 - 244 * Math.cos(RAD_60)),  r: 30, label: '3 lateral', shape: 'rect', direction: 210 },
      { id: 'lateral_right_b3_4',     x: Math.round(580 + 304 * Math.sin(RAD_60)),  y: Math.round(580 - 304 * Math.cos(RAD_60)),  r: 30, label: '4 lateral', shape: 'rect', direction: 210 },
      // ── taps b1 ───────────────────────────────────────────────────────
  ...
  4: {
    ...
    pinya: [
      ...
      { id: 'agulla_b1',              x: 550, y: 500, r: 20,       label: 'agulla',     shape: 'rect', direction: 270 },
      ...
      { id: 'agulla_b2',              x: 500, y: 450, r: 20,       label: 'agulla',     shape: 'rect', direction: 180 },
      ...
      { id: 'agulla_b3',              x: 450, y: 500, r: 20,       label: 'agulla',     shape: 'rect', direction: 90  },
      ...
      { id: 'agulla_b4',              x: 500, y: 550, r: 20,       label: 'agulla',     shape: 'rect', direction: 0   },
      ...
      { id: 'vent_b1_1',              x: Math.round(500 + 50 + 124 * Math.cos(RAD_45)),  y: Math.round(500 - 50 - 124 * Math.sin(RAD_45)),  r: 35, label: '1 vent', shape: 'rect', direction: 225 },
      { id: 'vent_b1_2',              x: Math.round(500 + 50 + 184 * Math.cos(RAD_45)),  y: Math.round(500 - 50 - 184 * Math.sin(RAD_45)),  r: 35, label: '2 vent', shape: 'rect', direction: 225 },
      { id: 'vent_b1_3',              x: Math.round(500 + 50 + 244 * Math.cos(RAD_45)),  y: Math.round(500 - 50 - 244 * Math.sin(RAD_45)),  r: 35, label: '3 vent', shape: 'rect', direction: 225 },
      { id: 'vent_b1_4',              x: Math.round(500 + 50 + 304 * Math.cos(RAD_45)),  y: Math.round(500 - 50 - 304 * Math.sin(RAD_45)),  r: 35, label: '4 vent', shape: 'rect', direction: 225 },
      // ── vent b2 (upper-left diagonal, NW @ 135°) ───────────────────────────
      { id: 'vent_b2_1',              x: Math.round(500 - 50 + 124 * Math.cos(RAD_135)), y: Math.round(500 - 50 - 124 * Math.sin(RAD_135)), r: 35, label: '1 vent', shape: 'rect', direction: 135 },
      { id: 'vent_b2_2',              x: Math.round(500 - 50 + 184 * Math.cos(RAD_135)), y: Math.round(500 - 50 - 184 * Math.sin(RAD_135)), r: 35, label: '2 vent', shape: 'rect', direction: 135 },
      { id: 'vent_b2_3',              x: Math.round(500 - 50 + 244 * Math.cos(RAD_135)), y: Math.round(500 - 50 - 244 * Math.sin(RAD_135)), r: 35, label: '3 vent', shape: 'rect', direction: 135 },
      { id: 'vent_b2_4',              x: Math.round(500 - 50 + 304 * Math.cos(RAD_135)), y: Math.round(500 - 50 - 304 * Math.sin(RAD_135)), r: 35, label: '4 vent', shape: 'rect', direction: 135 },
      // ── vent b3 (lower-left diagonal, SW @ 225°) ───────────────────────────
      { id: 'vent_b3_1',              x: Math.round(500 - 50 + 124 * Math.cos(RAD_225)), y: Math.round(500 + 50 - 124 * Math.sin(RAD_225)), r: 35, label: '1 vent', shape: 'rect', direction: 45  },
      { id: 'vent_b3_2',              x: Math.round(500 - 50 + 184 * Math.cos(RAD_225)), y: Math.round(500 + 50 - 184 * Math.sin(RAD_225)), r: 35, label: '2 vent', shape: 'rect', direction: 45  },
      { id: 'vent_b3_3',              x: Math.round(500 - 50 + 244 * Math.cos(RAD_225)), y: Math.round(500 + 50 - 244 * Math.sin(RAD_225)), r: 35, label: '3 vent', shape: 'rect', direction: 45  },
      { id: 'vent_b3_4',              x: Math.round(500 - 50 + 304 * Math.cos(RAD_225)), y: Math.round(500 + 50 - 304 * Math.sin(RAD_225)), r: 35, label: '4 vent', shape: 'rect', direction: 45  },
      // ── vent b4 (lower-right diagonal, SE @ 315°) ──────────────────────────
      { id: 'vent_b4_1',              x: Math.round(500 + 50 + 124 * Math.cos(RAD_315)), y: Math.round(500 + 50 - 124 * Math.sin(RAD_315)), r: 35, label: '1 vent', shape: 'rect', direction: 315 },
      { id: 'vent_b4_2',              x: Math.round(500 + 50 + 184 * Math.cos(RAD_315)), y: Math.round(500 + 50 - 184 * Math.sin(RAD_315)), r: 35, label: '2 vent', shape: 'rect', direction: 315 },
      { id: 'vent_b4_3',              x: Math.round(500 + 50 + 244 * Math.cos(RAD_315)), y: Math.round(500 + 50 - 244 * Math.sin(RAD_315)), r: 35, label: '3 vent', shape: 'rect', direction: 315 },
      { id: 'vent_b4_4',              x: Math.round(500 + 50 + 304 * Math.cos(RAD_315)), y: Math.round(500 + 50 - 304 * Math.sin(RAD_315)), r: 35, label: '4 vent', shape: 'rect', direction: 315 },
      // ── lateral left b1 (SE, lower arm @ 315°) ─────────────────────────────────
      { id: 'lateral_left_b1_1',      x: Math.round(650 + 124 * Math.cos(RAD_315)), y: Math.round(500 - 124 * Math.sin(RAD_315)), r: 30, label: 'b1 left 1 lateral',  shape: 'rect', direction: 0   },
      { id: 'lateral_left_b1_2',      x: Math.round(650 + 204 * Math.cos(RAD_315)), y: Math.round(500 - 204 * Math.sin(RAD_315)), r: 30, label: 'b1 left 2 lateral',  shape: 'rect', direction: 0   },
      { id: 'lateral_left_b1_3',      x: Math.round(650 + 284 * Math.cos(RAD_315)), y: Math.round(500 - 284 * Math.sin(RAD_315)), r: 30, label: 'b1 left 3 lateral',  shape: 'rect', direction: 0   },
      { id: 'lateral_left_b1_4',      x: Math.round(650 + 364 * Math.cos(RAD_315)), y: Math.round(500 - 364 * Math.sin(RAD_315)), r: 30, label: 'b1 left 4 lateral',  shape: 'rect', direction: 0   },
      // ── lateral right b1 (NE, upper arm @ 45°) ─────────────────────────────────
      { id: 'lateral_right_b1_1',     x: Math.round(650 + 124 * Math.cos(RAD_45)),  y: Math.round(500 - 124 * Math.sin(RAD_45)),  r: 30, label: 'b1 right 1 lateral', shape: 'rect', direction: 180 },
      { id: 'lateral_right_b1_2',     x: Math.round(650 + 204 * Math.cos(RAD_45)),  y: Math.round(500 - 204 * Math.sin(RAD_45)),  r: 30, label: 'b1 right 2 lateral', shape: 'rect', direction: 180 },
      { id: 'lateral_right_b1_3',     x: Math.round(650 + 284 * Math.cos(RAD_45)),  y: Math.round(500 - 284 * Math.sin(RAD_45)),  r: 30, label: 'b1 right 3 lateral', shape: 'rect', direction: 180 },
      { id: 'lateral_right_b1_4',     x: Math.round(650 + 364 * Math.cos(RAD_45)),  y: Math.round(500 - 364 * Math.sin(RAD_45)),  r: 30, label: 'b1 right 4 lateral', shape: 'rect', direction: 180 },
      // ── lateral left b2 (NE, right arm @ 45°) ─────────────────────────────────
      { id: 'lateral_left_b2_1',      x: Math.round(500 + 124 * Math.cos(RAD_45)),  y: Math.round(350 - 124 * Math.sin(RAD_45)),  r: 30, label: 'b2 left 1 lateral',  shape: 'rect', direction: 90 },
      { id: 'lateral_left_b2_2',      x: Math.round(500 + 204 * Math.cos(RAD_45)),  y: Math.round(350 - 204 * Math.sin(RAD_45)),  r: 30, label: 'b2 left 2 lateral',  shape: 'rect', direction: 90 },
      { id: 'lateral_left_b2_3',      x: Math.round(500 + 284 * Math.cos(RAD_45)),  y: Math.round(350 - 284 * Math.sin(RAD_45)),  r: 30, label: 'b2 left 3 lateral',  shape: 'rect', direction: 90 },
      { id: 'lateral_left_b2_4',      x: Math.round(500 + 364 * Math.cos(RAD_45)),  y: Math.round(350 - 364 * Math.sin(RAD_45)),  r: 30, label: 'b2 left 4 lateral',  shape: 'rect', direction: 90 },
      // ── lateral right b2 (NW, left arm @ 135°) ─────────────────────────────────
      { id: 'lateral_right_b2_1',     x: Math.round(500 + 124 * Math.cos(RAD_135)), y: Math.round(350 - 124 * Math.sin(RAD_135)), r: 30, label: 'b2 right 1 lateral', shape: 'rect', direction: 270 },
      { id: 'lateral_right_b2_2',     x: Math.round(500 + 204 * Math.cos(RAD_135)), y: Math.round(350 - 204 * Math.sin(RAD_135)), r: 30, label: 'b2 right 2 lateral', shape: 'rect', direction: 270 },
      { id: 'lateral_right_b2_3',     x: Math.round(500 + 284 * Math.cos(RAD_135)), y: Math.round(350 - 284 * Math.sin(RAD_135)), r: 30, label: 'b2 right 3 lateral', shape: 'rect', direction: 270 },
      { id: 'lateral_right_b2_4',     x: Math.round(500 + 364 * Math.cos(RAD_135)), y: Math.round(350 - 364 * Math.sin(RAD_135)), r: 30, label: 'b2 right 4 lateral', shape: 'rect', direction: 270 },
      // ── lateral left b3 (NW, upper arm @ 135°) ─────────────────────────────────
      { id: 'lateral_left_b3_1',      x: Math.round(350 + 124 * Math.cos(RAD_135)), y: Math.round(500 - 124 * Math.sin(RAD_135)), r: 30, label: 'b3 left 1 lateral',  shape: 'rect', direction: 0 },
      { id: 'lateral_left_b3_2',      x: Math.round(350 + 204 * Math.cos(RAD_135)), y: Math.round(500 - 204 * Math.sin(RAD_135)), r: 30, label: 'b3 left 2 lateral',  shape: 'rect', direction: 0 },
      { id: 'lateral_left_b3_3',      x: Math.round(350 + 284 * Math.cos(RAD_135)), y: Math.round(500 - 284 * Math.sin(RAD_135)), r: 30, label: 'b3 left 3 lateral',  shape: 'rect', direction: 0 },
      { id: 'lateral_left_b3_4',      x: Math.round(350 + 364 * Math.cos(RAD_135)), y: Math.round(500 - 364 * Math.sin(RAD_135)), r: 30, label: 'b3 left 4 lateral',  shape: 'rect', direction: 0 },
      // ── lateral right b3 (SW, lower arm @ 225°) ─────────────────────────────────
      { id: 'lateral_right_b3_1',     x: Math.round(350 + 124 * Math.cos(RAD_225)), y: Math.round(500 - 124 * Math.sin(RAD_225)), r: 30, label: 'b3 right 1 lateral', shape: 'rect', direction: 180 },
      { id: 'lateral_right_b3_2',     x: Math.round(350 + 204 * Math.cos(RAD_225)), y: Math.round(500 - 204 * Math.sin(RAD_225)), r: 30, label: 'b3 right 2 lateral', shape: 'rect', direction: 180 },
      { id: 'lateral_right_b3_3',     x: Math.round(350 + 284 * Math.cos(RAD_225)), y: Math.round(500 - 284 * Math.sin(RAD_225)), r: 30, label: 'b3 right 3 lateral', shape: 'rect', direction: 180 },
      { id: 'lateral_right_b3_4',     x: Math.round(350 + 364 * Math.cos(RAD_225)), y: Math.round(500 - 364 * Math.sin(RAD_225)), r: 30, label: 'b3 right 4 lateral', shape: 'rect', direction: 180 },
      // ── lateral left b4 (SW, left arm @ 225°) ─────────────────────────────────
      { id: 'lateral_left_b4_1',      x: Math.round(500 + 124 * Math.cos(RAD_225)), y: Math.round(650 - 124 * Math.sin(RAD_225)), r: 30, label: 'b4 left 1 lateral',  shape: 'rect', direction: 270 },
      { id: 'lateral_left_b4_2',      x: Math.round(500 + 204 * Math.cos(RAD_225)), y: Math.round(650 - 204 * Math.sin(RAD_225)), r: 30, label: 'b4 left 2 lateral',  shape: 'rect', direction: 270 },
      { id: 'lateral_left_b4_3',      x: Math.round(500 + 284 * Math.cos(RAD_225)), y: Math.round(650 - 284 * Math.sin(RAD_225)), r: 30, label: 'b4 left 3 lateral',  shape: 'rect', direction: 270 },
      { id: 'lateral_left_b4_4',      x: Math.round(500 + 364 * Math.cos(RAD_225)), y: Math.round(650 - 364 * Math.sin(RAD_225)), r: 30, label: 'b4 left 4 lateral',  shape: 'rect', direction: 270 },
      // ── lateral right b4 (SE, right arm @ 315°) ─────────────────────────────────
      { id: 'lateral_right_b4_1',     x: Math.round(500 + 124 * Math.cos(RAD_315)), y: Math.round(650 - 124 * Math.sin(RAD_315)), r: 30, label: 'b4 right 1 lateral', shape: 'rect', direction: 90  },
      { id: 'lateral_right_b4_2',     x: Math.round(500 + 204 * Math.cos(RAD_315)), y: Math.round(650 - 204 * Math.sin(RAD_315)), r: 30, label: 'b4 right 2 lateral', shape: 'rect', direction: 90  },
      { id: 'lateral_right_b4_3',     x: Math.round(500 + 284 * Math.cos(RAD_315)), y: Math.round(650 - 284 * Math.sin(RAD_315)), r: 30, label: 'b4 right 3 lateral', shape: 'rect', direction: 90  },
      { id: 'lateral_right_b4_4',     x: Math.round(500 + 364 * Math.cos(RAD_315)), y: Math.round(650 - 364 * Math.sin(RAD_315)), r: 30, label: 'b4 right 4 lateral', shape: 'rect', direction: 90  },
      // ── taps b1 ───────────────────────────────────────────────────────
      { id: 'tap_right_b1_1',         x: 910, y: 410, r: R_petita, label: '1 tap',                direction: 250 },
      { id: 'tap_right_b1_2',         x: 950, y: 390, r: 30,       label: '2 tap', shape: 'rect', direction: 250 },
      { id: 'tap_left_b1_1',          x: 910, y: 590, r: R_petita, label: '1 tap',                direction: 285 },
      { id: 'tap_left_b1_2',          x: 950, y: 610, r: 30,       label: '2 tap', shape: 'rect', direction: 290 },
      // ── taps b2 ───────────────────────────────────────────────────────
      { id: 'tap_left_b2_1',          x: 590, y: 90, r: R_petita,  label: '1 tap',                direction: 200 },
      { id: 'tap_left_b2_2',          x: 610, y: 50, r: 30,        label: '2 tap', shape: 'rect', direction: 200 },
      { id: 'tap_right_b2_1',         x: 410, y: 90, r: R_petita,  label: '1 tap',                direction: 160 },
      { id: 'tap_right_b2_2',         x: 390, y: 50, r: 30,        label: '2 tap', shape: 'rect', direction: 160 },
      // ── taps b3 ───────────────────────────────────────────────────────
      { id: 'tap_left_b3_1',          x: 90, y: 410, r: R_petita,  label: '1 tap',                direction: 110 },
      { id: 'tap_left_b3_2',          x: 50, y: 390, r: 30,        label: '2 tap', shape: 'rect', direction: 110 },
      { id: 'tap_right_b3_1',         x: 90, y: 590, r: R_petita,  label: '1 tap',                direction: 70  },
      { id: 'tap_right_b3_2',         x: 50, y: 610, r: 30,        label: '2 tap', shape: 'rect', direction: 70  },
      // ── taps b4 ───────────────────────────────────────────────────────
      { id: 'tap_left_b4_1',          x: 410, y: 910, r: R_petita, label: '1 tap',                direction: 20  },
      { id: 'tap_left_b4_2',          x: 390, y: 950, r: 30,       label: '2 tap', shape: 'rect', direction: 20  },
      { id: 'tap_right_b4_1',         x: 590, y: 910, r: R_petita, label: '1 tap',                direction: 340 },
      { id: 'tap_right_b4_2',         x: 610, y: 950, r: 30,       label: '2 tap', shape: 'rect', direction: 340 },
    ],
  },
}
